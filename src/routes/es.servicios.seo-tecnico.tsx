...
export const Route = createFileRoute("/es/servicios/seo-tecnico")({
  head: () => ({
    ...
    links: [{ rel: "alternate", hrefLang: "en", href: "https://rankyourbrand.co/services/technical-seo" }],
  }),
  component: () => (
    <ServiceDetail
      tag="SEO Técnico"
      ...
      includes={[
        ...
        ["Fase 2 — Keywords y arquitectura", "Investigación de keywords con mayor volumen de búsqueda y construcción de una arquitectura transaccional de valor que sienta las bases de un sitio web estructurado y funcional."],
