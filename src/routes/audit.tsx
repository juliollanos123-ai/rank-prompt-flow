...
const AUDIT_ITEMS = [
  ...
  "RYB service recommendation",
];

export const Route = createFileRoute("/audit")({
  head: () => ({
    meta: [
      { title: "Free Website Diagnosis — Rank Your Brand" },
      {
        name: "description",
        content:
          "Get a clear picture of your digital visibility in 48 hours — completely free. 7-point analysis covering SEO health, AI visibility and the technical issues blocking your rankings.",
      },
      { property: "og:title", content: "Free Website Diagnosis — Rank Your Brand" },
      { property: "og:description", content: "48-hour free diagnosis. No commitment required." },
    ],
  }),
  component: AuditPage,
});
        ...
        <div className="mx-auto max-w-7xl px-6 text-canvas lg:px-10">
          ...
          <Reveal delay={0.1}>
            <h1 className="mt-8 max-w-5xl text-balance text-5xl text-canvas lg:text-[clamp(3.5rem,7vw,6.5rem)]">
              Discover why your competitors{" "}
              <span className="italic">show up before you do.</span>
            </h1>
          </Reveal>
          <Reveal delay={0.2}>
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_1.4fr] lg:items-start">
            ...
            <Reveal>
              <div className="rounded-3xl border border-prompt bg-canvas p-8 lg:p-10 shadow-card">
                ...
                <h2 className="mt-6 text-3xl lg:text-4xl">Free Website Diagnosis</h2>
                <p className="mt-3 text-ink/65">Delivered in 48 hours. No commitment required.</p>

                <div className="mt-8 font-display text-6xl text-prompt">Free</div>
                ...
                <div className="mt-8 pt-4 border-t border-border text-xs uppercase tracking-widest text-ink/50">
                  Deliverable: <span className="text-ink/80">PDF report (5–7 pages)</span>
                </div>
              </div>
            </Reveal>
...
function AuditForm({ onSubmit }: { onSubmit: () => void }) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <Eyebrow>Request your free diagnosis</Eyebrow>
      ...
      >
        {loading ? "Sending…" : "Get my free diagnosis"}
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
      ...
      <h2 className="mt-4 text-3xl lg:text-4xl">
        Your free diagnosis will arrive{" "}
        <span className="italic text-prompt">within 48 hours.</span>
      </h2>
      <ol className="mt-8 space-y-4 text-ink/75">
        ...
        <li><strong className="text-ink">3.</strong> We include a tailored service recommendation.</li>
      </ol>
