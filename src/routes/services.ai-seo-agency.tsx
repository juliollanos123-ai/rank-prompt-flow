...
export const Route = createFileRoute("/services/ai-seo-agency")({
  head: () => ({
    meta: [
      { title: "AI SEO Agency — The authority AI recommends | Rank Your Brand" },
      { name: "description", content: "Premium GEO + thought leadership program for B2B brands ready to dominate their category. 12-month engagement." },
      { property: "og:title", content: "AI SEO Agency — Rank Your Brand" },
      { property: "og:description", content: "Become the brand AI cites by default in your category." },
    ],
    links: [{ rel: "alternate", hrefLang: "es", href: "https://rankyourbrand.co/es/servicios/agencia-seo-ia" }],
  }),
  component: () => (
    <ServiceDetail
      tag="AI SEO Agency"
