...
export const Route = createFileRoute("/es/servicios/agencia-seo-ia")({
  head: () => ({
    meta: [
      { title: "Agencia SEO IA para B2B | Rank Your Brand" },
      { name: "description", content: "Optimizamos tu marca para ser citada por ChatGPT, Perplexity y Google AI Overviews. Generative Engine Optimization (GEO) + SEO de entidades para empresas B2B." },
      { property: "og:title", content: "Agencia SEO IA para B2B | Rank Your Brand" },
      { property: "og:description", content: "Conviértete en la marca que la IA cita por defecto en tu categoría." },
    ],
    links: [
      { rel: "canonical", href: "https://rankyourbrand.co/es/servicios/agencia-seo-ia" },
