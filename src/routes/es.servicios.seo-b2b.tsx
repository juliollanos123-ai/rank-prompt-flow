...
export const Route = createFileRoute("/es/servicios/seo-b2b")({
  head: () => ({
    meta: [
      { title: "SEO para B2B — Retainer Mensual | Rank Your Brand" },
      { name: "description", content: "SEO mensual para empresas B2B que hace crecer tu tráfico orgánico de forma predecible. Estrategia de keywords, producción de contenido y optimización con IA. Retainer de 6 meses." },
      { property: "og:title", content: "SEO para B2B — Retainer Mensual | Rank Your Brand" },
      { property: "og:description", content: "Crecimiento orgánico compuesto, cada mes." },
    ],
    links: [
      { rel: "canonical", href: "https://rankyourbrand.co/es/servicios/seo-b2b" },
